...
from .views import create_qs_with_future_sunrise_livestreams
import pytz
...
class IndexViewTests(TestCase):
    @freeze_time("2023-11-15 05:30:00", tz_offset=0)
    def test_choose_correct_livestream(self):
        ...
        sydney_sunrise_time_today = datetime(
            2023, 11, 14, 6, 30, 0, tzinfo=pytz.timezone(sydney_timezone)
        )
        ...
        create_qs_with_future_sunrise_livestreams(livestreams)
